                ...
                <div className="lg:w-[60%]">
                    <div>
                        <div className="px-5 pt-10 h-auto flex gap-2 flex-col justify-center bg-white rounded-md shadow-sm m-auto">
                            ...
                            <p className="font-medium text-sm text-drak-gray"><span className="text-light-gray">Nome: </span>Marcelo Almeida Gomes</p>
                            <p className="font-medium text-sm text-drak-gray"><span className="text-light-gray">CPF: </span>000.000.000-00</p>
                            <p className="font-medium text-sm text-drak-gray"><span className="text-light-gray">Email: </span>marcelogostariadeumestagio@gmail.com</p>
                            <p className="font-medium text-sm text-drak-gray"><span className="text-light-gray">Celular: </span>&#40;85&#41; 9999-9999</p>
                        </div>
                        <div className="px-5 h-auto flex gap-2 flex-col justify-center bg-white rounded-md shadow-sm m-auto">
                            ...
                            <p className="font-medium text-sm text-drak-gray"><span className="text-light-gray">Endereço: </span>Rua Nas mão de Deus, 33</p>
                            ...
                            <p className="font-medium text-sm text-drak-gray"><span className="text-light-gray">CEP: </span>00000-000</p>
                        </div>
                        <div className="px-5 pb-10 h-auto flex gap-2 flex-col justify-center bg-white rounded-md shadow-sm m-auto">
                            ...
                            <span className="my-5 p-5 bg-[#F6AA1C]/[.15]">
                                <p className="flex justify-between text-lg font-bold text-dark-gray-2">Total: <span>R$ 249,99</span></p>
                                <p className="text-xs text-light-gray text-end">ou 10x de R$ 24,99 sem juros</p>
                            </span>
